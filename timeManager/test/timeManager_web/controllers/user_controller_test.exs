defmodule TimeManagerWeb.UserControllerTest do
  ...
  @create_attrs %{name: "some name", username: "some username", email: "some email"}
  @update_attrs %{name: "some updated name", username: "some updated username", email: "some updated email"}
